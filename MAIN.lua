...
-- // Valiant ENV
loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/rizatin/RIZ/main/ENV.lua"))()
...
-- // Silent Aim Vars
local AimHacks = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/rizatin/RIZ/main/VARS.lua"))()
